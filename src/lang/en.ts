export const en = {
    ...
    hero: {
      title: "Transforming Spaces into Intelligent Experiences.",
    ...
    services: {
        ...
        lounge: {
          ...
          description: "Streamline your operations with our AI-driven unmanned lounge solutions.\n\n" +
            "Designed for industries like hospitality and retail, our technology handles everything " +
            "from customer check-ins to environment control—without the need for on-site staff.\n\n" +
            "Enjoy reduced costs and 24/7 operational efficiency, all while providing a seamless " +
            "and personalized experience for your customers."
        }
    },      
    future: {
      title: "Future Growth",
